...
class GerenciadorDeSessoes {
  ...
  static const _users = [
    ...
    Usuario._('Alejandra', 'alejandra', 'alXa'),
    Usuario._('Adrian', 'adrian', 'adXn'),
    Usuario._('Murilo', 'murilo', 'muXo'),
    Usuario._('Leonardo', 'leonardo', 'leXo'),
    Usuario._('Rafael', 'rafael', 'raXl'),
    Usuario._('Gustavo', 'gustavo', 'guXo'),
    Usuario._('Kaua', 'kaua', 'kaXa'),
    Usuario._('Joao', 'joao', 'joXo'),
  ];
